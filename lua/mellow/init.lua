...
local set_groups = function()
    local highlights = {
        ...
        { hg = "StatusLine", fg = c.white, bg = c.gray01, gui = "bold" }, -- status line of current window
        ...
        { hg = "Winbar", fg = c.white, bg = c.gray01, gui = "bold" }, -- Winbar
        { hg = "WinbarNC", fg = c.gray05, bg = c.bg_dark }, -- Winbar non-current windows.
        { hg = "WinBarError", fg = c.cyan, gui = "bold,italic" },

        { hg = "EndOfBuffer", fg = c.bg },
        { hg = "NvimTreeEndOfBuffer", fg = c.bg_darker },

        { hg = "NvimTreeNormal", bg = c.bg_darker },

        { hg = "TelescopeMatching", fg = c.cyan },
        { hg = "TelescopeSelection", bg = c.gray01 },

        { hg = "rainbowcol1", fg = c.rain1 },
        { hg = "rainbowcol3", fg = c.rain3 },
        ...
        { hg = "@punctuation.delimiter", fg = c.red },
        { hg = "@punctuation.bracket", fg = c.yellow },
